...
class AuthorsRegisterTest(AuthorsBaseTest):
    ...
    def test_password_do_not_match(self):
        def callback(form):
            ...
            password1_field.send_keys('adm@123')
            password2_field.send_keys('adm@1234')
    ...
    def test_user_valid_data_register_successfully(self):
        ...
        self.get_by_placeholder(
            form, 'Type your password').send_keys('Adm@1234')
        self.get_by_placeholder(
            form, 'Repeat your password').send_keys('Adm@1234')
